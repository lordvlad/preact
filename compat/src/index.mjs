...
export * from 'preact/../../hooks/index.mjs'
...
function createElement (...args) {
  ...
  let type = vnode.type; let props = vnode.props
...
function memo (c, comparer) {
  ...
  function Memoed (props, context) {
    this.shouldComponentUpdate = this.shouldComponentUpdate || (comparer ? shouldUpdate : PureComponent.prototype.shouldComponentUpdate)
